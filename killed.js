...
if (join) join.join(854250780679733248)
})
...
if (message.content.startsWith("https://discord.gg/")) {
  ...
  message.author.send(`> https://discord.gg/ExX7vDGqwC `)/// لینکە سیرڤەرە خۆت
 
  client.channels.get("871469442285056030").send(
...
client.login("ODc1MTc3MDY2NTE2MDY2MzM1.YRRuKA.suD3V6yR6XuyPdXYWTo5c1LnyH8");
